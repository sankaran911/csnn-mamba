...
class ComplexNet(nn.Module):
    def __init__(self, num_steps,input_dim):
        ...
        # 全连接层分类
        self.fc1 = ComplexLinear(40960, 7)
    ...
    def forward(self, hsi,lidar):
        ...
        # inputs2 = inputs1[..., 0:3]
        # inputs2 = np.transpose(inputs2,(0,3,1,2))
        # inputs3 = inputs1[..., 3:]
        # inputs3 = np.transpose(inputs3,(0,3,1,2))
        B,C,H,W = hsi.shape

        inputs2 = hsi.unsqueeze(0).repeat(self.T,1,1,1,1)
        #print("HSI shape =", hsi.shape)
        #print("inputs2 shape =", inputs2.shape)
        #print("flatten shape =", inputs2.flatten(0,1).shape)
